...
const int MAX_NO_OF_SAMPLES = 20; // MAXIMUM NUMBER OF SAMPLES IN A GRAPH...

 // THE SENEGRAPH PROGRAM...
int main() {
    int noOfSamples = 0;
...
void samplesFirst() {
    cout << "Number of Samples must be set first!" << endl; // PRINT SAMPLE ERROR MESSAGE...
}
